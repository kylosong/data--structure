...
import class04.Code03_DoubleLinkedListToDeque;
...
/**
 * todo：自己实现的popHead，popTail还是有点问题，有时间再看
 */
public class demo04 {
    public static void main(String[] args) {
//        DoubleQueue<String> doubleQueue = new DoubleQueue<>();
//        doubleQueue.offerHead("a");
//        doubleQueue.offerHead("b");
//        doubleQueue.offerTail("c");
//        doubleQueue.offerTail("c");
//        doubleQueue.offerTail("d");
//        System.out.println(doubleQueue.peekHead());
//        System.out.println(doubleQueue.peekTail());
//        System.out.println(doubleQueue.popHead());
//        System.out.println(doubleQueue.peekHead());
        testDeque();
    }
